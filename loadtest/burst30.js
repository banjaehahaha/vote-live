/**
 * k6: 30명 동시 사용자가 각 1회씩 POST /api/vote (발표 실전에 가까운 규모)
 * sid=burst30, choice는 ITEM|IMAGE|DATA|NEAR 랜덤
 * 실행: BASE_URL=https://your-app.vercel.app k6 run loadtest/burst30.js
 */
